...
module.exports = function(async, FriendResult){  //FriendResult
    ...
    return {
        ...
        getchatPage: function(req, res){
            async.parallel([
                ...
                res.render('private/privatechat', {title: 'FightingBees - Private Chat', user:req.user, data: result1, chat: result2, chats:result3, name:nameParams});
            });
        },
