...
module.exports = function(async, FriendResult){
    return {
        ...
        getProfilePage: function(req, res){
            async.parallel([
                ...
                res.render('user/profile', {title: 'Fighting Bees - Profile', user:req.user, data: result1, chat:result2});
            });
        },
        ...
        overviewPage: function(req, res){
            async.parallel([
                ...
                res.render('user/overview', {title: 'Fighting Bees - Overview', user:req.user, data: result1, chat:result2});
            });
        },
